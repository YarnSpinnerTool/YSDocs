# DialogueRunner.AddCommandHandler(string,System.Func<T1, T2, T3, IEnumerator>)
...
|`System.Func<T1, T2, T3, IEnumerator>` handler|The  <code>CommandHandler</code>  that will be invoked when the command is called.|
