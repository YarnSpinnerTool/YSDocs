...
While Yarn Spinner for Rust is engine agnostic, the recommended way is to use [Bevy](https://bevyengine.org/). It is a refreshingly simple data-driven game engine built in Rust.
We will assume that you went through the [Bevy Book](https://bevyengine.org/learn/book/introduction/) before continuing with this chapter.
