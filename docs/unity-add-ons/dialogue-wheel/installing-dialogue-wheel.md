...
{% hint style="info" %}
To use the Dialogue Wheel for Yarn Spinner package in Unity, you'll also need to make sure you've got the Yarn Spinner for Unity package [installed](../../yarn-spinner-for-unity/yarn-spinner-for-unity/installation-and-setup.md). &#x20;
{% endhint %}
