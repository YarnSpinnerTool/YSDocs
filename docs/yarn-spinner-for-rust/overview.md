...
See [the Rust section in the Beginner's Guide](../3-new-in-v3/making-a-game/yarn-spinner-for-rust.md) for a quickstart into how to setup everything you need to before reading on.
