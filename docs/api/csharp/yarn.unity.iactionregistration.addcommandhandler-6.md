# IActionRegistration.AddCommandHandler(string,System.Func<T1, T2, T3, Coroutine>)
...
|`System.Func<T1, T2, T3, Coroutine>` handler|The  <code>CommandHandler</code>  that will be invoked when the command is called.|
