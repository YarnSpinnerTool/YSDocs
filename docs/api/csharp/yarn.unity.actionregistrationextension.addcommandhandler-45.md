# ActionRegistrationExtension.AddCommandHandler<T1>(IActionRegistration,string,System.Func<T1, Coroutine>)
...
```csharp
public static void AddCommandHandler<T1>(this IActionRegistration registration, string commandName, System.Func<T1, Coroutine> handler);
```
...
|`Func<T1, Coroutine>` handler|The  <a href="yarn.commandhandler.md">CommandHandler</a>  that will be invoked when the command is called.|
