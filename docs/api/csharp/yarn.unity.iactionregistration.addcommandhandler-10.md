# IActionRegistration.AddCommandHandler(string,System.Func<IEnumerator>)
...
|`System.Func<IEnumerator>` handler|The  <code>CommandHandler</code>  that will be invoked when the command is called.|
