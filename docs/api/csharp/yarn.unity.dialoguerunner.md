...
|[AddFunction(string,System.Func<TResult, T1, T2, T3, T4>)](/docs/api/csharp/yarn.unity.dialoguerunner.addfunction-6.md)|Add a new function that returns a value, so that it can be called from Yarn scripts.|
