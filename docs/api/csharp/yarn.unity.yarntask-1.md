...
|[FromResult<T>(T)](/docs/api/csharp/yarn.unity.yarntask.fromresult-2.md)||
...
|[WaitForAsyncOperation<T>(AsyncOperationHandle<T>,CancellationToken)](/docs/api/csharp/yarn.unity.yarntask.waitforasyncoperation-2.md)||
...
|[WhenAll<T>(IEnumerable<YarnTask<T>>)](/docs/api/csharp/yarn.unity.yarntask.whenall-4.md)||
|[WhenAll<T>(YarnTask<T>[])](/docs/api/csharp/yarn.unity.yarntask.whenall-3.md)||
