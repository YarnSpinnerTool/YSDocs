# AddCommandHandler(IActionRegistration,string,System.Func\<T1, System.Threading.Tasks.Task>)
...
| `Func<T1, System.Threading.Tasks.Task>` handler                                  | The [CommandHandler](yarn.commandhandler.md) that will be invoked when the command is called. |
