# ActionRegistrationExtension.AddCommandHandler<T1, T2, T3, T4, T5, T6, T7>(IActionRegistration,string,System.Func<T1, T2, T3, T4, T5, T6, T7, YarnTask>)
...
|`Func<T1, T2, T3, T4, T5, T6, T7, Yarn.Unity.YarnTask>` handler|The  <a href="yarn.commandhandler.md">CommandHandler</a>  that will be invoked when the command is called.|
