...
|[NextContentToken](/docs/api/csharp/yarn.unity.linecancellationtoken.nextcontenttoken.md)||
...
|[IsNextContentRequested](/docs/api/csharp/yarn.unity.linecancellationtoken.isnextcontentrequested.md)||
