...
{% hint style="warning" %}
This method is <b>obsolete</b> and may be removed from a future version of Yarn Spinner: SaveStateToPlayerPrefs is deprecated, please use SaveStateToPersistentStorage instead.
{% endhint %}
