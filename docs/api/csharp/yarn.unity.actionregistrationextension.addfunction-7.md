# ActionRegistrationExtension.AddFunction<T1, T2, T3, T4, T5, T6, TResult>(IActionRegistration,string,System.Func<T1, T2, T3, T4, T5, T6, TResult>)
...
|`Func<T1, T2, T3, T4, T5, T6, TResult>` implementation|The  <code>System.Delegate</code>  that should be invoked when this function is called.|
