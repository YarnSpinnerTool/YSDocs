...
|[GetRange(ParserRuleContext)](/docs/api/csharp/yarn.compiler.utility.getrange.md)|Gets the range covered by a  <code>Antlr4.Runtime.ParserRuleContext</code>  in the source code.|
...
|[ParseSourceText(string,string)](/docs/api/csharp/yarn.compiler.utility.parsesourcetext.md)|Parses a string of Yarn source code, and produces a  <a href="yarn.compiler.fileparseresult.md">FileParseResult</a> .|
