...
|[RequestOptionHurryUp()](/docs/api/csharp/yarn.unity.lineadvancer.requestoptionhurryup.md)||
...
|[RunOptionsAsync(DialogueOption[],LineCancellationToken)](/docs/api/csharp/yarn.unity.lineadvancer.runoptionsasync.md)|Called by a dialogue presenter to signal that options are running.|
