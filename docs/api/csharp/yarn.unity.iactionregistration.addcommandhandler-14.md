# IActionRegistration.AddCommandHandler(string,System.Func<T1, T2, T3, T4, IEnumerator>)
...
|`System.Func<T1, T2, T3, T4, IEnumerator>` handler|The  <code>CommandHandler</code>  that will be invoked when the command is called.|
