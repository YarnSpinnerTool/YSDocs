...
{% hint style="warning" %}
This page describes advanced usage of Yarn Spinner. Unless you really need total control over how Yarn Spinner works in your Unity project, we recommend using the built-in [Dialogue Runner](../yarn-spinner-for-game-engines/unity/components/dialogue-runner.md) class rather than creating your own.
