...
And that's the very basics of Yarn Spinner Scripting! Dive into the [Fundamentals](write-yarn-scripts/scripting-fundamentals/) of Writing Yarn Scripts next.
