...
You can define your own custom functions in Yarn Spinner. For more information, see [# Defining Commands and Functions ](../../yarn-spinner-for-game-engines/yarn-spinner-for-unity/creating-commands-functions.md).
