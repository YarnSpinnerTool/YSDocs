...
In a Unity game, you can use this tag in a custom [Dialogue View](../../yarn-spinner-for-game-engines/unity/components/dialogue-view/custom-dialogue-views.md) to be notified ahead of time when the player is about to be shown options.
...
For more details (including what the tag should look like), see [Adding Line IDs](../../yarn-spinner-for-game-engines/unity/assets-and-localization/#adding-line-ids).
...
As referenced before, the Yarn Spinner integration for Unity uses line tags to link localised dialogue lines. This is better explained in the [Localization and Assets](../../yarn-spinner-for-game-engines/unity/assets-and-localization/) section.
