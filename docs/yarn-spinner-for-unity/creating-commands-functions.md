...
[Functions](../write-yarn-scripts/editing-with-vs-code/functions.md) are units of code that Yarn scripts can call to receive a value.

In addition to the [built-in functions](../write-yarn-scripts/editing-with-vs-code/functions.md#built-in-functions) that come with Yarn Spinner, you can create your own.
