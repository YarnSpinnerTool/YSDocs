...
A Yarn Project's inspector shows information about every [variable](../../write-yarn-scripts/editing-with-vs-code/logic-and-variables.md) that are used in the Yarn scripts. This section of the Inspector shows the name, type, description, and default value of each variable.
