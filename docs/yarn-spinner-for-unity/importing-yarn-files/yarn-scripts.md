...
The new file that you've just created will contain a single [node](../../write-yarn-scripts/editing-with-vs-code/lines-nodes-and-options.md#writing-nodes-in-plain-text), which has the same name as the file.
