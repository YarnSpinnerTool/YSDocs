...
* The values of [variables](../../write-yarn-scripts/logic-and-variables/) are stored and retrieved using the Dialogue Presenter's [Variable Storage](../../yarn-spinner-for-other-engines/godot/components/variable-storage/).
