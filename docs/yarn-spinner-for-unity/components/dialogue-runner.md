...
* The values of [variables](../../writing-dialogue-in-yarn/writing-in-yarn/logic-and-variables.md) are stored and retrieved using the Dialogue Runner's [Variable Storage](variable-storage/).
