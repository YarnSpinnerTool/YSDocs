...
| On Option Selected            | A Unity Event that's fired when an option is selected from a [Dialogue View](dialogue-view/README.md). The event contains the index of the option which was selected.                                                                                                                                                                                                                                                     |
