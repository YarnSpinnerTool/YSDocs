...
To use Speech Bubbles for Yarn Spinner, you'll need to create a new Unity project and [install he Yarn Spinner package](../../using-yarnspinner-with-unity/installation-and-setup.md), and then [install the Speech Bubbles for Yarn Spinner package](installing-speech-bubbles.md).
