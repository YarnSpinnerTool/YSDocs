...
To use Speech Bubbles for Yarn Spinnet, you'll need to create a new Unity project and [install he Yarn Spinner package](../../using-yarnspinner-with-unity/installation-and-setup.md).&#x20;
