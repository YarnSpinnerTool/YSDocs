...
The Six-Segment Dialogue Wheel provides a dialogue wheel with a simple graphical appearance, and can—theoretically—support as many options as you'd like, automatically adjusting to display them.&#x20;
...
And that's everything you need to know to use the Six-Segment! The next section discusses the Six-Segment Dialogue Wheel.
